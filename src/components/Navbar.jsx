        ...
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="#home" className="navbar-brand p-0">
                    <h1 className="text-primary m-0"><span style={{ color: '#37249D' }}><i className="fa fa-map-marked-alt me-3"></i>Tour</span><span style={{ color: "red" }}>Go</span></h1>
                </a>
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    <div className="navbar-nav ms-auto py-0">
                        ...
                        <a href="#scheduler" className="nav-item nav-link">Scheduler</a>
                        <a href="#recommendation" className="nav-item nav-link">Recommendation</a>
                        <a href="#about" className="nav-item nav-link">About Us</a>
                        <a href="#services" className="nav-item nav-link">Services</a>
                        <a href="#contact" className="nav-item nav-link">Contact Us</a>
                    </div>
                    <li className="nav-item dropdown loginGuestDD" id="loginGuestDD">
