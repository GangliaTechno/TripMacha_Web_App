...
const Login = () => {
    ...
    return (
        <>
            ...
            <div style={{ background: "rgba(0,0,0,0.5)" }} className="modal fade" id="SignupSigninModal" tabindex="-1" role="dialog" aria-labelledby="SignupSigninModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title w-100 text-center" id="exampleModalLongTitle">Login/SignIn</h4>
                            <button type="button" ref={closebtnRef} className="close" data-dismiss="modal" aria-label="Close" hidden>
                        ...
                        <div className="modal-body signin_modal">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-12 mt-3">
                                    <a onClick={applepop} className="btn-lg btn-apple rounded-pill btn-block text-uppercase fs-6 my-3" href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="27" height="27" viewBox="0 0 50 50" className="mb-1 me-3">
