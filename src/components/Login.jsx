                        ...
                        <div className="modal-body signin_modal">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <a className="btn-lg btn-google rounded-pill btn-block text-uppercase fs-6" href="#">
                                ...
                                <div className="col-md-12 mt-3">
                                    <a className="btn-lg btn-apple rounded-pill btn-block text-uppercase fs-6" href="#">
