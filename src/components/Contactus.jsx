                                    ...
                                    <div className="row g-3">
                                        <div className="col-md-6">
                                            <div className="form-floating">
                                                <input type="text" className="form-control bg-transparent shadow-none text-white" id="name" name="formName" placeholder="Your name" />
                                                <label for="name" className="text-white">Your Name</label>
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="form-floating">
                                                <input type="email" className="form-control bg-transparent shadow-none text-white" id="mailID" name="mailId" placeholder="Your Contact Number" />
                                                <label for="phone" className="text-white">Your Email-ID</label>
                                            </div>
                                        </div>
                                        <div className="col-12">
                                            <div className="form-floating">
                                                <input type="text" className="form-control bg-transparent shadow-none text-white" id="subject" name="subject" placeholder="Your Email-ID" />
                                                <label for="email" className="text-white">Subject</label>
                                            </div>
                                        </div>
                                        <div className="col-12">
                                            <div className="form-floating">
                                                <textarea className="form-control bg-transparent shadow-none text-white" placeholder="Special Request" name="message" id="message" style={{ height: "100px" }} ></textarea>
